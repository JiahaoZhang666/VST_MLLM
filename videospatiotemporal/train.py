...
import sys
sys.path.append('./')
from videospatiotemporal.model import *
from videospatiotemporal.constants import NUM_FRAMES, IGNORE_INDEX, MODAL_INDEX_MAP
from videospatiotemporal.mm_utils import tokenizer_multimodal_token, process_video, process_image, annToMask
from videospatiotemporal.videorefer_trainer import (VideoReferTrainer,
